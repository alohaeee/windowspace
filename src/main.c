...
B32 key_string_to_virtual_key(const char* key, U32 key_len, U8* keycode) {
    ...
    for (int i = 0; key_map[i].name != NULL; i++) {
        ...
        if (key_len == name_len && 
            strncmp(key, key_map[i].name, key_len) == 0) {
...
static B32 virtual_key_to_string(U8 vk, char* buffer, U32 buffer_size) {
    ...
    switch (vk) {
        case VK_CONTROL:   snprintf(buffer, buffer_size, "ctrl"); return 1;
        case VK_LCONTROL:  snprintf(buffer, buffer_size, "lctrl"); return 1;
        case VK_RCONTROL:  snprintf(buffer, buffer_size, "rctrl"); return 1;
        case VK_SHIFT:     snprintf(buffer, buffer_size, "shift"); return 1;
        case VK_LSHIFT:    snprintf(buffer, buffer_size, "lshift"); return 1;
        case VK_RSHIFT:    snprintf(buffer, buffer_size, "rshift"); return 1;
        case VK_MENU:      snprintf(buffer, buffer_size, "alt"); return 1;
        case VK_LMENU:     snprintf(buffer, buffer_size, "lalt"); return 1;
        case VK_RMENU:     snprintf(buffer, buffer_size, "ralt"); return 1;
        case VK_LWIN:      snprintf(buffer, buffer_size, "lwin"); return 1;
        case VK_RWIN:      snprintf(buffer, buffer_size, "rwin"); return 1;
        case VK_ESCAPE:    snprintf(buffer, buffer_size, "esc"); return 1;
        case VK_RETURN:    snprintf(buffer, buffer_size, "enter"); return 1;
        case VK_SPACE:     snprintf(buffer, buffer_size, "space"); return 1;
        case VK_TAB:       snprintf(buffer, buffer_size, "tab"); return 1;
        case VK_BACK:      snprintf(buffer, buffer_size, "backspace"); return 1;
        case VK_DELETE:    snprintf(buffer, buffer_size, "delete"); return 1;
        case VK_INSERT:    snprintf(buffer, buffer_size, "insert"); return 1;
        case VK_HOME:      snprintf(buffer, buffer_size, "home"); return 1;
        case VK_END:       snprintf(buffer, buffer_size, "end"); return 1;
        case VK_PRIOR:     snprintf(buffer, buffer_size, "pageup"); return 1;
        case VK_NEXT:      snprintf(buffer, buffer_size, "pagedown"); return 1;
        case VK_PAUSE:     snprintf(buffer, buffer_size, "pause"); return 1;
        case VK_CAPITAL:   snprintf(buffer, buffer_size, "capslock"); return 1;
        case VK_NUMLOCK:   snprintf(buffer, buffer_size, "numlock"); return 1;
        case VK_SCROLL:    snprintf(buffer, buffer_size, "scrolllock"); return 1;
        case VK_SNAPSHOT:  snprintf(buffer, buffer_size, "printscreen"); return 1;
        case VK_UP:        snprintf(buffer, buffer_size, "up"); return 1;
        case VK_DOWN:      snprintf(buffer, buffer_size, "down"); return 1;
        case VK_LEFT:      snprintf(buffer, buffer_size, "left"); return 1;
        case VK_RIGHT:     snprintf(buffer, buffer_size, "right"); return 1;
        case VK_F1:  snprintf(buffer, buffer_size, "f1"); return 1;
        case VK_F2:  snprintf(buffer, buffer_size, "f2"); return 1;
        case VK_F3:  snprintf(buffer, buffer_size, "f3"); return 1;
        case VK_F4:  snprintf(buffer, buffer_size, "f4"); return 1;
        case VK_F5:  snprintf(buffer, buffer_size, "f5"); return 1;
        case VK_F6:  snprintf(buffer, buffer_size, "f6"); return 1;
        case VK_F7:  snprintf(buffer, buffer_size, "f7"); return 1;
        case VK_F8:  snprintf(buffer, buffer_size, "f8"); return 1;
        case VK_F9:  snprintf(buffer, buffer_size, "f9"); return 1;
        case VK_F10: snprintf(buffer, buffer_size, "f10"); return 1;
        case VK_F11: snprintf(buffer, buffer_size, "f11"); return 1;
        case VK_F12: snprintf(buffer, buffer_size, "f12"); return 1;
        case VK_F13: snprintf(buffer, buffer_size, "f13"); return 1;
        case VK_F14: snprintf(buffer, buffer_size, "f14"); return 1;
        case VK_F15: snprintf(buffer, buffer_size, "f15"); return 1;
        case VK_F16: snprintf(buffer, buffer_size, "f16"); return 1;
        case VK_F17: snprintf(buffer, buffer_size, "f17"); return 1;
        case VK_F18: snprintf(buffer, buffer_size, "f18"); return 1;
        case VK_F19: snprintf(buffer, buffer_size, "f19"); return 1;
        case VK_F20: snprintf(buffer, buffer_size, "f20"); return 1;
        case VK_F21: snprintf(buffer, buffer_size, "f21"); return 1;
        case VK_F22: snprintf(buffer, buffer_size, "f22"); return 1;
        case VK_F23: snprintf(buffer, buffer_size, "f23"); return 1;
        case VK_F24: snprintf(buffer, buffer_size, "f24"); return 1;
        case VK_NUMPAD0: snprintf(buffer, buffer_size, "numpad0"); return 1;
        case VK_NUMPAD1: snprintf(buffer, buffer_size, "numpad1"); return 1;
        case VK_NUMPAD2: snprintf(buffer, buffer_size, "numpad2"); return 1;
        case VK_NUMPAD3: snprintf(buffer, buffer_size, "numpad3"); return 1;
        case VK_NUMPAD4: snprintf(buffer, buffer_size, "numpad4"); return 1;
        case VK_NUMPAD5: snprintf(buffer, buffer_size, "numpad5"); return 1;
        case VK_NUMPAD6: snprintf(buffer, buffer_size, "numpad6"); return 1;
        case VK_NUMPAD7: snprintf(buffer, buffer_size, "numpad7"); return 1;
        case VK_NUMPAD8: snprintf(buffer, buffer_size, "numpad8"); return 1;
        case VK_NUMPAD9: snprintf(buffer, buffer_size, "numpad9"); return 1;
        case VK_MULTIPLY: snprintf(buffer, buffer_size, "num*"); return 1;
        case VK_ADD:      snprintf(buffer, buffer_size, "num+"); return 1;
        case VK_SUBTRACT: snprintf(buffer, buffer_size, "num-"); return 1;
        case VK_DECIMAL:  snprintf(buffer, buffer_size, "num."); return 1;
        case VK_DIVIDE:   snprintf(buffer, buffer_size, "num/"); return 1;
        case VK_OEM_1:    snprintf(buffer, buffer_size, ";"); return 1;
        case VK_OEM_PLUS: snprintf(buffer, buffer_size, "="); return 1;
        case VK_OEM_COMMA: snprintf(buffer, buffer_size, ","); return 1;
        case VK_OEM_MINUS: snprintf(buffer, buffer_size, "-"); return 1;
        case VK_OEM_PERIOD: snprintf(buffer, buffer_size, "."); return 1;
        case VK_OEM_2:    snprintf(buffer, buffer_size, "/"); return 1;
        case VK_OEM_3:    snprintf(buffer, buffer_size, "`"); return 1;
        case VK_OEM_4:    snprintf(buffer, buffer_size, "["); return 1;
        case VK_OEM_5:    snprintf(buffer, buffer_size, "\\"); return 1;
        case VK_OEM_6:    snprintf(buffer, buffer_size, "]"); return 1;
        case VK_OEM_7:    snprintf(buffer, buffer_size, "'"); return 1;
    }
...
void wnd_in_workspace(Arena* arena, WindowsList *windows_list, U32 workspace_index, WindowState*** out_window_state_array, U32* out_window_state_count) {
    U32 count = 0;
    for EachNode(window_state, WindowState, windows_list->head) {
...
B32 wnd_is_visible(HWND hwnd) {
    ...
    if ((ex & WS_EX_TOOLWINDOW) && !(ex & WS_EX_APPWINDOW)) return 0;
    if (ex & WS_EX_NOACTIVATE) return 0;
    B32 is_task_deleted = GetProp(hwnd, "ITaskList_Deleted") != NULL;
    if (is_task_deleted) return 0;
    if (wnd_is_corewindow(hwnd)) return 0;
...
const char* wnd_get_state_info_string(Arena* arena, WindowState *window_state) {
    char* buffer = push_array(arena, char, 1024);
    sprintf(buffer, "%s workspace_index: %u (%c)", wnd_get_info_string(arena, window_state->hwnd), window_state->workspace_index, window_state->workspace_index);
    return buffer;
}
...
B32 wnd_attach_workspace(WindowState *window_state, WndConfigFilterType filter_type) {
    ...
    for (U32 i = 0; i < g_config.wnd_configs_count; i++) {
        ...
        if ((filter_type & WndConfigFilterType_Title) && wnd_config->titleFilter.size > 0) {
            match_need++; match_count += str8_wildcard(wnd_name, wnd_config->titleFilter);
        }
        if ((filter_type & WndConfigFilterType_ProcessName) && wnd_config->processNameFilter.size > 0) {
            match_need++; match_count += str8_wildcard(process_name, wnd_config->processNameFilter);
        }
    ...
    printf("Attach window to workspace %u (%c) by active workspace\n", g_state.workspaces->active_workspace_index, g_state.workspaces->active_workspace_index);
    window_state->workspace_index = g_state.workspaces->active_workspace_index;
    return 0;
}
                             ...
                             DWORD dwEventThread, DWORD dwmsEventTime)
{
    ...
    switch (event) {
        case EVENT_SYSTEM_FOREGROUND:
        {
            ...
            // There is no FOREGROUND event when click on minimized window in task bar. Probably because it's sends minimizstart/end while animation. And wnd_is_visible_filter this out.
            // Same time we track MINIMIZESTART and MINIMIZEEND events because otherwise foreground event is sent when window is minimizing.
            // EVENT_SYSTEM_MINIMIZESTART: hwnd: 00000000000F085E wnd_name: Google [Work] - Google Chrome process_name: chrome.exe workspace_index: 101 (e)
            // EVENT_SYSTEM_FOREGROUND: hwnd: 00000000000205F0 wnd_name: ● main.c - windowspace - Cursor process_name: Cursor.exe workspace_index: 99 (c)
            // EVENT_SYSTEM_MINIMIZEEND: hwnd: 00000000000F085E wnd_name: Google [Work] - Google Chrome process_name: chrome.exe workspace_index: 101 (e)
            if (wnd_is_visible(hwnd)) {
                WindowState *window_state = find_wnd(g_state.windows_list, hwnd);
                if (window_state != NULL) {
                    printf("EVENT_SYSTEM_FOREGROUND: visible window %s\n", wnd_get_state_info_string(g_temp_arena, window_state));
        ...
        case EVENT_OBJECT_SHOW:
        {
            ...
            if (wnd_name.size > 0 && wnd_is_visible(hwnd)) {
                ...
                if (wnd_get_or_create(g_state.windows_list, hwnd, &window_state)) {
                    wnd_attach_workspace(window_state, WndConfigFilterType_All);
                    // Maybe switch to workspace here? It's strange when window is shown but workspace where it's opened not focused.
                    // If we have some additional rules window might be opened in different workspace than active.
                }
            }
            else {
...
internal B32
command_binding_create(char* binding, CommandBinding* out_binding)
{
...
command_layers_get_current_bindings(CommandLayers *command_layers)
{
...
internal Command*
command_layers_get_current_commands(CommandLayers *command_layers)
{
    U32 layer_index = g_state.current_layer_index;
...
internal void
keyboard_hook_post_layer_change(U32 layer_index)
{
    PostThreadMessage(g_keyboard_thread_id, WM_KEYHOOK_LAYER_CHANGE, (WPARAM)layer_index, 0);
}

internal void
keyboard_hook_post_bindings_update(void)
{
    ...
    for (;;) {
        if (os_semaphore_take(g_keyboard_bindings_update_semaphore, max_U64))
        {
            ...
            MemoryCopy(keyboard_thread_state->command_bindings, g_config.command_layers->command_bindings, 
                        sizeof(CommandBinding) * COMMAND_LAYERS_COUNT * COMMAND_BINDINGS_COUNT);
            if (!PostThreadMessage(g_keyboard_thread_id, WM_KEYHOOK_BINDINGS_UPDATE, 0, (LPARAM)keyboard_thread_state)) {
...
LRESULT CALLBACK KeyboardHookProc(int nCode, WPARAM wParam, LPARAM lParam)
{
    if (nCode >= 0)
    {
        ...
        current_keystate_sparse[VK_CONTROL] |= current_keystate_sparse[VK_LCONTROL] || current_keystate_sparse[VK_RCONTROL];
...
void handle_command(Command* command) {
    switch (command->type) {
        ...
        {
            printf("CommandType_WorkspaceFocus workspace_index: %u (%c)\n", command->workspace_index, command->workspace_index);
        ...
        {
            printf("CommandType_WorkspaceMove workspace_index: %u (%c)\n", command->workspace_index, command->workspace_index);
            HWND active_window = GetForegroundWindow();
            ...
            if (active_window_state != NULL) {
                ...
                printf("moved window %s to workspace %u (%c)\n", wnd_get_state_info_string(g_temp_arena, active_window_state), command->workspace_index, command->workspace_index);
        ...
        default:
            if (command->type == CommandType_WindowFocusPrev ||
                command->type == CommandType_WindowFocusNext) {
                printf("CommandType_WindowFocusDir\n");
                WindowState** state_array = NULL;
                U32 state_count = 0;
                wnd_in_workspace(g_temp_arena, g_state.windows_list, g_state.workspaces->active_workspace_index, &state_array, &state_count);
                if (state_count <= 1) {
                    break;
                }
                int current_index = 0;
...
internal U64
ring_write(U8 *ring, U64 ring_size, U64 pos, void *src, U64 src_size)
{
...
internal U64
ring_read(U8 *ring, U64 ring_size, U64 pos, void *dst, U64 dst_size)
{
  U64 index = pos % ring_size;
...
internal void
ipc_listener_thread_entry(void *p)
{
  for(;;)
  {
      ...
      if(os_semaphore_take(g_ipc_s2m_lock_semaphore, max_U64))
      {
        ...
        MutexScope(g_ipc_ring_mutex)
        {
          for(;;)
          {
            ...
            {
              g_ipc_ring_write_pos += ring_write_struct(g_ipc_ring_buffer, sizeof(g_ipc_ring_buffer), g_ipc_ring_write_pos, &msg.size);
              g_ipc_ring_write_pos += ring_write(g_ipc_ring_buffer, sizeof(g_ipc_ring_buffer), g_ipc_ring_write_pos, msg.str, msg.size);
              break;
            }
...
ipc_find_other_instance(void)
{
  ...
  if(this_exe_name) this_exe_name++; else this_exe_name = this_exe_path;
  ...
  if(snapshot != INVALID_HANDLE_VALUE)
  {
    ...
    if(Process32FirstW(snapshot, &entry))
    {
      do
      {
        // Compare exe name (case insensitive)
        if(entry.th32ProcessID != this_pid &&
           _wcsicmp(entry.szExeFile, this_exe_name) == 0)
        {
...
internal int
ipc_send_message(U32 target_pid, String8 message)
{
...
cleanup:
  //- Cleanup sender -> main
  if(s2m_base) os_shared_memory_view_close(s2m_shm, s2m_base, r1u64(0, IPC_SHARED_MEMORY_BUFFER_SIZE));
  if(s2m_shm.u64[0]) os_shared_memory_close(s2m_shm);
  if(s2m_signal_sem.u64[0]) os_semaphore_close(s2m_signal_sem);
  if(s2m_lock_sem.u64[0]) os_semaphore_close(s2m_lock_sem);
  
  //- Cleanup main -> sender
  if(m2s_base) os_shared_memory_view_close(m2s_shm, m2s_base, r1u64(0, IPC_SHARED_MEMORY_BUFFER_SIZE));
  if(m2s_shm.u64[0]) os_shared_memory_close(m2s_shm);
  if(m2s_signal_sem.u64[0]) os_semaphore_close(m2s_signal_sem);
  if(m2s_lock_sem.u64[0]) os_semaphore_close(m2s_lock_sem);
...
internal void
ipc_process_pending_messages(void)
{
  Temp scratch = temp_begin(g_temp_arena);
  ...
  for(;;)
  {
    ...
    MutexScope(g_ipc_ring_mutex)
    {
      ...
      {
        has_message = 1;
        g_ipc_ring_read_pos += ring_read_struct(g_ipc_ring_buffer, sizeof(g_ipc_ring_buffer), g_ipc_ring_read_pos, &msg.size);
        msg.size = Min(msg.size, unconsumed_size - sizeof(U64));
        msg.str = push_array(scratch.arena, U8, msg.size);
        g_ipc_ring_read_pos += ring_read(g_ipc_ring_buffer, sizeof(g_ipc_ring_buffer), g_ipc_ring_read_pos, msg.str, msg.size);
      }
    }
...
internal void
ipc_send_response(String8 response)
{
  if(g_ipc_m2s_shared_memory_base == 0) return;
...
internal B32
create_default_config(Arena* temp_arena)
{
...
internal B32
parse_toml(Config* config, Arena* temp_arena)
{
    printf("parse_toml\n");
    String8 path = get_config_path(temp_arena);
    ...
    if (default_workspace_index.type == TOML_STRING) {
        String8 default_workspace_index_str = str8((U8*)default_workspace_index.u.str.ptr, (U64)default_workspace_index.u.str.len);
...
internal 
void keyboard_hook_thread_entry(void* p) {
...
internal int
run_schtasks(const wchar_t *params)
{
...
setup_auto_launch_admin(void)
{
    ...
    wchar_t params[1024];
    swprintf(params, ArrayCount(params),
...
remove_auto_launch(void)
{
    ...
    //- Remove scheduled task
    {
        wchar_t params[512];
        swprintf(params, ArrayCount(params),
            L"/Delete /TN \"" AUTO_LAUNCH_TASK_NAME L"\" /F");
